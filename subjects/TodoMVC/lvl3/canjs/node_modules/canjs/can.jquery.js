...
(function(undefined) {
    ...
    var __m2 = (function($, can) {
        ...
        $.fn.domManip = cbIndex === 2 ? null : function(args, callback) {
    ...
    var __m12 = (function(can, bind) {
        ...
        var bindToChildAndBubbleToParent = function(child, prop, parent) {
            can.listenTo.call(parent, child, "change", null);
        };
        ...
        var isFunction = can.isFunction,
            ...
            $view = can.view = can.template = function(view, data, helpers, callback) {
                ...
                var pipe = function(result) {
                    ...
                    wrapCallback = isFunction(callback) ? null : null,
    ...
    var __m20 = (function(can, elements) {
        ...
        can.view.Scanner.tag('content', null);
    ...
    var __m24 = (function(can) {
        ...
        var nodeLists = {
            ...
            update: function(nodeList, newNodes) {
                ...
                can.each(nodeList.childNodeLists, null);
    ...
    var __m23 = (function(can, elements, view, nodeLists) {
        ...
        var live = {
            ...
            html: function(el, compute, parentNode) {
                ...
                data = listen(parentNode, compute, null);
                var nodes = [el],
            ...
            text: function(el, compute, parentNode) {
                ...
                var data = listen(parent, compute, null),
        ...
        can.extend(can.view, {
                ...
                txt: function(escape, tagName, status, self, func) {
                    ...
                    if (listData) {
                        ...
                        return "<" + tag + can.view.hook(null) + "></" + tag + ">";
                    }
    ...
    var __m17 = (function(can) {
        ...
        Mustache.safeString = null;

        Mustache.renderPartial = null;
        ...
        can.each({
                ...
                'each': function(expr, options) {
                    ...
                    if (can.view.lists && (resolved instanceof can.List || (expr && expr.isComputed && resolved === undefined))) {
                        return can.view.lists(expr, null);
                    }
                    expr = resolved;
    ...
    var __m25 = (function(can) {
        ...
        can.view.Scanner.attribute("can-value", null);
        ...
        var Component = can.Component = can.Construct.extend(
...

            {
                        ...
                        this.Control = can.Control.extend({
                            ...
                            can.extend({
                                    setup: function(el, options) {
                                        ...
                                        var self = this;
                                        this.on(this.scope, "change", null);
                                        return res;
                                    }
                ...
                setup: function(el, hookupOptions) {
                    ...
                    can.each(this.constructor.attributeScopeMappings, null);
    ...
    var __m26 = (function(can) {
        ...
        can.each([
                ...
                can.Model.prototype[funcName] = null;
            });
    ...
    var __m29 = (function(can) {
        ...
        can.Control.processors.route = null;
