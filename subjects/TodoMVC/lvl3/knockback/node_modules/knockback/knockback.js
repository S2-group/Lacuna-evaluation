...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("knockout"), require("backbone"), require("underscore"), (null()));
	else if(typeof define === 'function' && define.amd)
		define(["knockout", "backbone", "underscore"], null);
	else if(typeof exports === 'object')
		exports["kb"] = factory(require("knockout"), require("backbone"), require("underscore"), (null()));
	else
...
/***/ function(module, exports, __webpack_require__) {
	...
	kb.CollectionObservable = (function() {
	      ...
	      return function() {
	        ...
	        _this._mapper = ko.computed(function() {
	          ...
	          if (!models || (current_collection.models.length === 0)) {
	            ...
	            models = _.filter(models, null);
	            if (comparator) {
	              view_models = _.map(models, null).sort(comparator);
	            } else {
	              if (_this.models_only) {
	                view_models = filters.length ? models : models.slice();
	              } else {
	                view_models = _.map(models, null);
	              }
	            }
	          }
	          _this.in_edit++;
	  ...
	  CollectionObservable.prototype.destroy = null;

	  CollectionObservable.prototype.shareOptions = null;

	  CollectionObservable.prototype.filters = null;

	  CollectionObservable.prototype.comparator = null;

	  CollectionObservable.prototype.sortAttribute = null;

	  CollectionObservable.prototype.viewModelByModel = null;

	  CollectionObservable.prototype.hasViewModels = null;

	  CollectionObservable.prototype.compact = null;
	  ...
	  CollectionObservable.prototype._onModelRemove = null;

	  CollectionObservable.prototype._onObservableArrayChange = null;

	  CollectionObservable.prototype._attributeComparator = null;

	  CollectionObservable.prototype._createViewModel = null;

	  CollectionObservable.prototype._selectModel = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = kb = (function() {
	  ...
	  kb.releaseOnNodeRemove = function(view_model, node) {
	    ...
	    return ko.utils.domNodeDisposal.addDisposeCallback(node, null);
	  };

	  kb.renderTemplate = null;
	  ...
	  kb.ignore = ((ref = ko.dependencyDetection) != null ? ref.ignore : void 0) || null;

	  kb.extend = __webpack_require__(4);

	  kb._throwMissing = null;

	  kb._throwUnexpected = null;
	  ...
	  kb.peek = function(obs) {
	    ...
	    return kb.ignore(null);
	  };

	  kb.isModel = null;

	  kb.isCollection = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = BackboneAssociations = (function() {
	  ...
	  BackboneAssociations.keys = null;

	  BackboneAssociations.relationType = null;

	  BackboneAssociations.useFunction = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = BackboneRelational = (function() {
	  ...
	  BackboneRelational.relationType = null;

	  BackboneRelational.bind = null;

	  BackboneRelational.useFunction = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Supermodel = (function() {
	  ...
	  Supermodel.keys = null;

	  Supermodel.relationType = null;

	  Supermodel.bind = null;

	  Supermodel.useFunction = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	kb.EventWatcher = (function() {
	  EventWatcher.useOptionsOrCreate = null;
	  ...
	  EventWatcher.prototype.destroy = null;
	  ...
	  EventWatcher.prototype.releaseCallbacks = null;
	  ...
	  EventWatcher.prototype._onModelUnloaded = null;

	  EventWatcher.prototype._unbindCallbacks = null;

	  return EventWatcher;

	})();

	kb.emitterObservable = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	kb.Factory = (function() {
	  ...
	  Factory.prototype.hasPath = null;

	  Factory.prototype.addPathMapping = function(path, create_info) {
	    return this.paths[path] = create_info;
	  };

	  Factory.prototype.addPathMappings = null;

	  Factory.prototype.hasPathMappings = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	kb.Observable = (function() {
	  ...
	  Observable.prototype.destroy = null;

	  Observable.prototype.value = null;

	  Observable.prototype.valueType = null;

	  Observable.prototype.update = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = TypedValue = (function() {
	  ...
	  TypedValue.prototype.destroy = null;

	  TypedValue.prototype.value = null;

	  TypedValue.prototype.rawValue = null;

	  TypedValue.prototype.valueType = null;

	  TypedValue.prototype.update = null;

	  TypedValue.prototype._updateValueObservable = null;

	  TypedValue.prototype._inferType = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = kb.Statistics = (function() {
	  ...
	  Statistics.prototype.clear = null;

	  Statistics.prototype.addModelEvent = null;

	  Statistics.prototype.modelEventsStatsString = null;

	  Statistics.prototype.register = null;

	  Statistics.prototype.unregister = null;

	  Statistics.prototype.registeredCount = null;

	  Statistics.prototype.registeredStatsString = null;

	  Statistics.prototype.registeredTracker = null;

	  Statistics.eventsStats = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = kb.Store = (function() {
	  ...
	  Store.prototype.destroy = null;

	  Store.prototype.clear = null;

	  Store.prototype.compact = null;
	  ...
	  Store.prototype.retainOrCreate = null;

	  Store.prototype.reuse = null;

	  Store.prototype.release = null;
	  ...
	  Store.prototype._refCount = null;
	  ...
	  Store.prototype._storeReferences = null;
	  ...
	  Store.prototype._clearStoreReferences = null;

	  Store.prototype._retire = null;
	  ...
	  Store.prototype._remove = null;

	  Store.prototype._creator = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = wrappedDestroy = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = unwrapModels = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	assignViewModelKey = null;

	createObservable = null;

	createStaticObservables = null;
	...
	kb.ViewModel = (function() {
	  ...
	  ViewModel.prototype.destroy = null;

	  ViewModel.prototype.shareOptions = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = kb.DefaultObservable = (function() {
	  ...
	  DefaultObservable.prototype.destroy = null;

	  DefaultObservable.prototype.setToDefault = null;

	  return DefaultObservable;

	})();

	kb.defaultObservable = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	kb.Observable.prototype.setToDefault = null;

	kb.ViewModel.prototype.setToDefault = null;

	kb.utils.setToDefault = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	kb.toFormattedString = null;

	kb.parseFormattedString = null;

	module.exports = kb.FormattedObservable = (function() {
	  

	  FormattedObservable.prototype.destroy = null;

	  return FormattedObservable;

	})();

	kb.formattedObservable = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = kb.LocalizedObservable = (function() {
	  ...
	  LocalizedObservable.prototype.destroy = null;

	  LocalizedObservable.prototype.resetToCurrent = null;

	  LocalizedObservable.prototype.observedValue = null;

	  LocalizedObservable.prototype._onLocaleChange = null;

	  return LocalizedObservable;

	})();

	kb.localizedObservable = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = kb.TriggeredObservable = (function() {
	  ...
	  TriggeredObservable.prototype.destroy = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	kb.valueValidator = null;

	kb.inputValidator = null;

	kb.formValidator = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	kb.hasChangedFn = null;

	kb.minLengthFn = null;

	kb.uniqueValueFn = null;

	kb.untilTrueFn = null;

	kb.untilFalseFn = null;
