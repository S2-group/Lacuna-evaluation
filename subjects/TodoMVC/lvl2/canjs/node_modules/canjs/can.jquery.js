...
(function(undefined) {
    ...
    var __m2 = (function($, can) {
        ...
        $.fn.domManip = cbIndex === 2 ? function(args, table, callback) {} : function(args, callback) {
        ...
        var isFunction = can.isFunction,
            ...
            $view = can.view = can.template = function(view, data, helpers, callback) {
                ...
                var pipe = function(result) {
                    ...
                    wrapCallback = isFunction(callback) ? function(frag) {} : null,
                ...
                if (can.isDeferred(result)) {
                    result.then(function(result, data) {}, function() {});
                    return deferred;
                }
                ...
                render: function(view, data, helpers, callback) {
                    ...
                    if (deferreds.length) {
                        ...
                        can.when.apply(can, deferreds)
                            .then(function(resolved) {}, function() {});
                        // Return the deferred...
                        return deferred;
                    } else {
        ...
        can.extend(can.view, {
                ...
                txt: function(escape, tagName, status, self, func) {
                    ...
                    if (listData) {
                        ...
                        return "<" + tag + can.view.hook(function(el, parentNode) {}) + "></" + tag + ">";
                    }
    ...
    var __m26 = (function(can) {
        ...
        var pipe = function(def, model, func) {
            ...
            makeRequest = function(self, type, success, error, method) {}, initializers = {
